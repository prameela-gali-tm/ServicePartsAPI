 ...
 * 
 * 
 * @Bean public ConsumerFactory<String, String> consumerFactory(){ final String
 * BOOTSTRAP_SERVERS="broker01-int.qa.awskafka.toyota.com:9094," +
 * "broker02-int.qa.awskafka.toyota.com:9094," +
 * "broker03-int.qa.awskafka.toyota.com:9094," +
 * "broker04-int.qa.awskafka.toyota.com:9094," +
 * "broker05-int.qa.awskafka.toyota.com:9094"; // HashMap to store the
 * configurations Map<String, Object> map = new HashMap<>();
 * 
 * // put the host IP inn the map map.put(ConsumerConfig
 * .BOOTSTRAP_SERVERS_CONFIG, BOOTSTRAP_SERVERS);
 * 
 * // put the group ID in the map map.put(ConsumerConfig .GROUP_ID_CONFIG,
 * "id"); map.put(ConsumerConfig .KEY_DESERIALIZER_CLASS_CONFIG,
 ...
 * kafkaListner() { ConcurrentKafkaListenerContainerFactory<String, String> obj
 * = new ConcurrentKafkaListenerContainerFactory<>();
 * obj.setConsumerFactory(consumerFactory()); return obj; } }
 */