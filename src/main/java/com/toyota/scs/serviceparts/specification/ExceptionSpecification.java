...
public class ExceptionSpecification  implements Specification<ExceptionEntity>{

	
	private String search;
	
	
	public ExceptionSpecification(String search) {
		super();
		this.search = search;
	}
	...
	@Override
	public Predicate toPredicate(Root<ExceptionEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
