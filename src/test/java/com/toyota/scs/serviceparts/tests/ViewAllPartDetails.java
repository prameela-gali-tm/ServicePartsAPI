...
@TestClass(description = "ViewAllPartDetails")
public class ViewAllPartDetails extends BaseTest {
	...
	@DataProvider(name = "ViewAllPartDetailsDataProvider")
...
//serial number and Part count matches
	@Test(priority = 1, dataProvider = "ViewAllPartDetailsDataProvider")
	public void verifyResponseonViewAllPartNumber(Integer row) throws Exception {

		test = rep.startTest("verifyResponseonViewAllPartNumber - verifyResponseonViewAllPartNumber");
		currentRow.set(row);
		...
		String rr = TestUtil.sendgetwithPathParams("http://dev-scs-parts-lb-48427546.us-west-2.elb.amazonaws.com/viewallpartdetails", hm);
